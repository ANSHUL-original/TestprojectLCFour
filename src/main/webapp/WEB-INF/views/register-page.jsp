	...
	<form:form action="register-form" method="post" modelAttribute="lcInfo">
		<div align="center">
			<p>
				...
				<form:input id="n" name="name" path=""
					placeholder="${ lcInfo.name }" />
				<form:errors cssClass="error" path="name"/>
				<br>
			</p>
			<p>
				<label for="un">User Name :</label>
				<form:input id="un" name="userName" path=""
					placeholder="${ lcInfo.userName }" />
				<br>
			</p>
			<p>
				<label for="p">Password :</label>
				<form:input id="p" type="password" path="password"/>
				<form:errors path="password" cssClass="error"/>	
			</p>
			<p>
				<label for="cp">Confirm Password :</label>
				<form:input id="cp" type="password" name="cnf_password" path="" />
				<br>
			</p>
			<p>
